# Generated by Django 3.2.5 on 2021-07-16 10:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='mainapp/images', verbose_name='Изображение товара')),
                ...
                ('sd_volume', models.CharField(max_length=255, verbose_name='Максимальный объём встраиваемой памяти')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_type', models.CharField(max_length=255, verbose_name='Технология экрана')),
                ('processor_freq', models.CharField(max_length=255, verbose_name='Тактовая частота процессора')),
                ('ram', models.CharField(max_length=255, verbose_name='Объём оперативной памяти')),
