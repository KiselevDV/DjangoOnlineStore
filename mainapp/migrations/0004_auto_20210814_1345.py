...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0003_auto_20210718_2147'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в обработке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='new', max_length=15, verbose_name='Статус заказа')),
